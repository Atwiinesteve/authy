              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  ...
                  <DropdownMenuItem>
                    ...
                    >
                      <Button className="w-56 rounded-none" type="submit">
                        Logout
                      </Button>
                    </form>
                  </DropdownMenuItem>
